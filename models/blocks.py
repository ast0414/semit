"""
Parts of the code are adapted and modified from
https://github.com/mingyuliutw/UNIT/blob/master/networks.py
...
class ConvTranspose2dBlock(nn.Module):
    def __init__(self, input_dim, output_dim, kernel_size, stride,
                 padding=0, output_padding=0, norm='none', activation='relu', pad_type='zero'):
        ...
        # initialize convolution
        self.dconv = nn.ConvTranspose2d(input_dim, output_dim, kernel_size, stride, padding, output_padding, bias=self.use_bias)
