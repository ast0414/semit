...
parser = argparse.ArgumentParser(description='SUIT for MNIST and KMNIST')
...
parser.add_argument('--save', default='/localscratch/san37/semit/SUIT', type=str, metavar='S', help='save path')
...
for epoch in tqdm(range(args.start_epoch, args.epochs), desc='Epoch'):
    ...
    for batch_idx in range(num_batch):
        ...
        data_2, target_2 = next(train_iter_2)
        ...
        errD_real_2 = loss_d_real_2 + loss_c_real_2
        ...
        errG_2_1 = args.lam0 * (loss_g2_d + loss_g2_c)
